...
DOMAIN_EXPANSIONS: dict[str, tuple[str, ...]] = {
    ...
    "access": ("access",),
    "auditspur": ("audit", "trace", "log", "transaction", "transaction log"),
    ...
    "ereignisspuren": ("event", "audit", "log", "transaction", "transaction log", "event log"),
    "ereignisse": ("event", "audit", "log", "transaction log", "event log"),
    ...
    "registerdaten": ("register", "registration", "authentic", "source", "authentic source"),
    ...
    "vertrauenswuerdige": ("trusted", "trusted list", "trusted lists", "qualified trust services"),
    "vertrauenswuerdigen": ("trusted", "trusted list", "trusted lists", "qualified trust services"),
