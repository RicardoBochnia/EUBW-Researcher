...
def _has_required_context(question: str, mapping: _CompiledTerminologyMapping) -> bool:
    ...
    for mapping in _COMPILED_TERMINOLOGY_MAPPINGS:
        for pattern in mapping.patterns:
            ...
            for match in matches:
                ...
                rebuilt_offset_map.extend(
                    [original_start] * len(mapping.canonical_term)
                )
    ...
    return [(source_term, canonical_term) for _, source_term, canonical_term in applied_with_positions]
